...
The reproducible offline [ML playground](research/ML_PLAYGROUND.md) builds and deduplicates the audio corpus, extracts a versioned event-feature dataset, compares thread-grouped logistic/random-forest experiments, exports conservative and challenger shadow models, and records predictions on future threads before retraining. These models do not currently alter the production userscript.
